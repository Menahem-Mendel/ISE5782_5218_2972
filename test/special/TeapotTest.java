...
public class TeapotTest {
	...
	private static final Material mat = new Material().setKd(new Double3(0.5)).setKs(new Double3(0.5)).setShininess(60);
	...
	public void teapot() {
		...
		camera.setRayTracer(new RayTracerBasic(scene).setBvh(true)).renderImage().printGrid(50, new Color(YELLOW)).writeToImage();
	}
