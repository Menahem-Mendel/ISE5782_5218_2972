...
public class RayTest {
	...
	public void findClosestPoint() {
		...
		List<Point> lst = new ArrayList<Point>(){{ add(new Point(2,2,2));
			 add(new Point(1,1,1));
			  add(new Point(3,3,3)); }};
		...
		List<Point> lst3 = new ArrayList<Point>(){{ add(new Point(1,1,1));
			add(new Point(2,2,2));
			 add(new Point(3,3,3)); }};
		...
		List<Point> lst4 = new ArrayList<Point>(){{ add(new Point(2,2,2));
			add(new Point(3,3,3));
			add(new Point(1,1,1)); }};
